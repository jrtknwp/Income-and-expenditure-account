...
let db; let screen = "home"; let editingId = null; let draft = newDraft(); let receiptBlob = null; let ocrState = { status:"idle", message:"" }; let historyFilters = { query:"", type:"all", category:"all", date:"" }; let summaryDate = new Date(); let summaryMode = "daily"; let summaryDay = localDate();
